...
from datasets.compute_esm import load_esm_model, compute_ESM_embeddings
...
class ESMFeaturizer:
    ...
    def precompute_esm_embedding(
        inputs: list, model_name, embedding_dir, sequence_fpath, checkpoint_dir, gpuid
    ):
        ...
        model, alphabet = load_esm_model(model_name, local_esm_dir=checkpoint_dir, gpuid=gpuid) 
        error_parts = []
