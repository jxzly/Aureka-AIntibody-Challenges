...
from datasets.constants import STD_RESIDUES, STD_RESIDUES_WITH_GAP, get_all_elems
from datasets.tokenizer import Token, TokenArray
from datasets.utils import get_atom_level_token_mask, get_ligand_polymer_bond_mask
...
class Featurizer(object):
    ...
    #     """
    #     atom_perm_list = []
    #     print(self.cropped_atom_array.res_perm)
